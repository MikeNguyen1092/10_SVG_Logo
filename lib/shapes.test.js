...
describe("Shape", () => {
	describe("circle", () => {
		it("circle string", () => {
            ...
            <text x="50%" y="50%" font-size="60" dominant-baseline="middle" text-anchor="middle" fill="purple">it</text>
            </svg>
            </svg>`.replace(/\s/g, "");
	...
	describe("triangle", () => {
		it("triangle string", () => {
            ...
            <text x="50%" y="55%" font-size="40" dominant-baseline="middle" text-anchor="middle" fill="white">him</text>
        </svg>`.replace(/\s/g, "");
	...
	describe("square", () => {
		it("square string", () => {
			...
			const result = newSquare.render("her", "white", "red");
            const expectSVG = `<svg version="1.1" width="250" height="250" xmlns="http://www.w3.org/2000/svg">
            <rect x="25" y="25" width="300" height="200" fill="red"/>
            <text x="50%" y="50%" font-size="60" dominant-baseline="middle" text-anchor="middle" fill="white">her</text>
            </svg>`.replace(/\s/g, "");
			expect(result.replace(/\s/g, "")).toEqual(expectSVG);
		});
	});
